    ...
    <xsl:template match="/">
        <fo:root>
            <fo:layout-master-set>
                <fo:simple-page-master master-name="proposal" margin-left="0.5in" margin-top="0.5in" margin-right="0.25in" margin-bottom="0.5in" page-width="8.5in" page-height="11in">
            ...
            <fo:page-sequence master-reference="proposal">
                ...
                <fo:flow flow-name="xsl-region-body">
                    ...
                    <fo:block-container xsl:use-attribute-sets="marginTop25">
                        <fo:block xsl:use-attribute-sets="generalFont font-16 alignCenter">Proposed Schedule for Geotechnical Services (This is not an Invoice) </fo:block>
                    </fo:block-container> 
                    
                    <fo:block-container xsl:use-attribute-sets="marginTop25">
                        <fo:block xsl:use-attribute-sets="generalFont font-16"><xsl:value-of select="proposal/Client/Contact"/></fo:block>
                        <fo:block xsl:use-attribute-sets="generalFont font-16"><xsl:value-of select="proposal/Client/Address"/></fo:block>
                        <fo:block xsl:use-attribute-sets="generalFont font-16"><xsl:value-of select="proposal/Client/City"/>,<fo:inline>&#160;</fo:inline><xsl:value-of select="proposal/Client/State"/> <fo:inline>&#160;</fo:inline> <xsl:value-of select="proposal/Client/Zip"/></fo:block>
                    </fo:block-container> 
                    
                    <fo:block-container xsl:use-attribute-sets="marginTop25">
                        <fo:block xsl:use-attribute-sets="generalFont font-16">Project Number <fo:inline>&#160;</fo:inline>  <xsl:value-of select="proposal/Project/projectnumber"/></fo:block>
                        <fo:block xsl:use-attribute-sets="generalFont font-16"><xsl:value-of select="proposal/Project/Title"/></fo:block>
                        <fo:block xsl:use-attribute-sets="generalFont font-16"><xsl:value-of select="proposal/Project/address"/></fo:block>
                        <fo:block xsl:use-attribute-sets="generalFont font-16"><xsl:value-of select="proposal/Project/city"/>,<fo:inline>&#160;</fo:inline>CA</fo:block>
                    </fo:block-container> 
                    
                    
                    <fo:block-container xsl:use-attribute-sets="marginTop25">
                        <fo:block xsl:use-attribute-sets="generalFont font-16"><xsl:value-of select="proposal/Proposal/ProposalDate"/></fo:block>
                    ...
                    <fo:block-container xsl:use-attribute-sets="marginTop25">
                        <fo:table
                            ...
                            <fo:table-body>
                                ...
                                <xsl:for-each select="proposal/Proposal/Items/*">
                    ...
                    <fo:block-container xsl:use-attribute-sets="marginTop25">
                        ...
                        <fo:block  xsl:use-attribute-sets="font-14 generalFont alignRight">
                            The total amount for this proposal is: $<xsl:value-of select="proposal/Proposal/totalAmount"/>
                        </fo:block>
                                ...
                                <fo:table-row>
                                    ...
                                    <fo:table-cell>
                                        <fo:block xsl:use-attribute-sets="font-14 generalFont boldFont">
                                            ...
                                            <xsl:value-of select="proposal/Proposal/status"/>
                                        </fo:block>
                                    </fo:table-cell>
                                    
                                    <fo:table-cell>
                                        <fo:block xsl:use-attribute-sets="font-14 generalFont boldFont alignRight">
                                            <fo:inline>Date Appooved: </fo:inline>
                                            <xsl:value-of select="proposal/Proposal/dateapproved"/>
                                        </fo:block>
                                    </fo:table-cell>
